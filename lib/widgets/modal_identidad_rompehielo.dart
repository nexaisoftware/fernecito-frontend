...
class _ModalOpcionesRompehieloState extends State<_ModalOpcionesRompehielo> {
  ...
  bool get _hayNuevas => widget.puedeNuevoYo || widget.squadsNuevos.isNotEmpty;
  ...
  Widget _cardContinuarSquad(SquadResumen s, RompehieloInvolucramiento h) {
    return _CardContinuarRompehielo(
      ...
      leading: _AvatarSquadModal(
        avatares: s.avataresMiembros,
        totalMiembros: s.cantidadMiembros,
        size: 32,
      ),
    );
  }
            ...
            ...widget.hilosActivos.map((h) {
              ...
              if (s == null) {
                return _CardContinuarRompehielo(
                  ...
                  leading: const _AvatarSquadModal(
                    avatares: [],
                    totalMiembros: 0,
                    size: 32,
                  ),
        ...
        children: [
          ...
          ...hilos.map((h) {
            ...
            return _CardContinuarRompehielo(
              ...
              leading: _AvatarSquadModal(
                avatares: s?.avataresMiembros ?? const [],
                totalMiembros: s?.cantidadMiembros ?? 0,
                size: 32,
              ),
            );
          }),
